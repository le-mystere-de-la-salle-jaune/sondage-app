...
import { Sondage, Stagiaire, ResultatSondage,OptionSondage } from '../domains';
...
export class SondageService {
  ...
  listerSondagesbyid(id:number):Promise<Sondage>  
  {
    ...
    .toPromise()
    .then((el:any) => new Sondage(el.id,el.titre,el.classe,el.options.map(el2 => new OptionSondage(el2.id,el2.libelle,el2.description))));
  }
